...
func New(indexName string, r io.Reader) (*Template, error) {
	...
	tmp.Template, err = template.New(indexName).Parse(html.UnescapeString(indexWithoutTemplates.String()))
	if err != nil {
		return nil, err
	}
